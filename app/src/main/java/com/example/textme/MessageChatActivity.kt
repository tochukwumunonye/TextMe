...
import com.example.textme.AdapterClasses.ChatsAdapter
import com.example.textme.Fragments.APIService
import com.example.textme.ModelClasses.Chat
import com.example.textme.ModelClasses.Users
import com.example.textme.Notifications.Client
import com.example.textme.Notifications.Data
...
class MessageChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        send_message_btn.setOnClickListener {
            ...
            if (message == ""){
                Toast.makeText(this@MessageChatActivity,
                    "Please write a message, first" , Toast.LENGTH_SHORT).show()
            }
            else{
        ...
        attach_image_filebtn.setOnClickListener {
            notify = true
            val intent = Intent()
    ...
    private fun sendMessageToUser(senderId: String, receiverId: String?, message: String) {
        ...
        reference.child("Chats")
            .child(messageKey!!).setValue(messageHashMap)
